...
def execute_grasp_preso():
    move_to_position([0, -0.5 , 0.00], [-1, 0, 0, 0.001])
    set_finger_positions([4000, 4000, 4000])
    rospy.sleep(2)
...
def execute_grasp():
    ...
    # close the fingers.
    rospy.sleep(0.1)
    set_finger_positions([6800, 6800, 6800])
    rospy.sleep(0.5)
...
if __name__ == '__main__':
    ...
    while not rospy.is_shutdown():
        ...
        #move_to_position([0, -0.3 , 0.7], [1, 0, 0, 0.0078])
        move_home()
